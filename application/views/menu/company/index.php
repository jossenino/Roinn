              	...
              	<div class="table-responsive">
	                <table class="table table-striped" id="companys">
						...
						<tr>
							...
							<td><?php echo anchor('menu/company/edit/' . $company->id, $company->pais); ?></td>
							<td><?php echo anchor('menu/company/edit/' . $company->id, $company->estado); ?></td>
							<td><?php echo anchor('menu/company/edit/' . $company->id, $company->ciudad); ?></td>

	...
	<div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title"><?php echo anchor('admin/profile/edit', '<i class="fa fa-plus"></i> Añadir perfil'); ?></h3>
              </div>
              <div class="box-body">
              	<div class="table-responsive">
	                <table id="Profiles" class="table table-striped">
						...
						<tbody>
							<?php if(count($profiles)): foreach($profiles as $profile): ?>	
						<tr>
							<td> <?php echo anchor('admin/profile/edit/' . $profile->idProfile, $profile->profile); ?></td>
							<td><?php echo anchor('admin/profile/edit/' . $profile->idProfile, $profile->description); ?></td>
							<td><?php echo btn_edit('admin/profile/edit/' . $profile->idProfile); ?>
								<?php echo btn_popup('admin/profile/profiles_popup/' . $profile->idProfile,"","showpermissions(".$profile->idProfile.")");?>
